...
import com.foodapp.FoodApp.email_notification.service.INotificationService;
...
public class UserServiceImpl implements IUserService{
    ...
    public User getCurrentLoggedInUser() {
        ...
        // The email is taken from the SecurityContext (trusted source set after login/JWT validation)
        // and used to load the full User entity from the database.
        // This avoids relying on client-provided data and ensures secure user identification.
    ...
    public Response<List<UserDTO>> getAllUsers() {
        ...
        // Java erases generic types at runtime, so List<UserDTO> cannot be passed directly.
        // TypeToken preserves the generic type information so ModelMapper knows
        // to map each User into a UserDTO inside the list.
        List<UserDTO> userListDTO = modelMapper.map(userList, new TypeToken<List<UserDTO>>() {}.getType());
    ...
    public Response<?> updateOwnAccount(UserDTO userDTO) {
        ...
        //check if new imageFile was provided which means that the user want to change profile photo
        ...
        if(userDTO.getEmail() != null && !userDTO.getEmail().equals(user.getEmail())){
            //check if the new email already taken
    ...
    public Response<?> deactivateOwnAccount() {
        ...
        NotificationDTO notificationDTO = NotificationDTO.builder()
                ...
                .body("Your aacount has been deactivated. If this was a mistake, please contact support.")
                .build();
