package com.foodapp.FoodApp.cart.controller;

import com.foodapp.FoodApp.cart.dtos.CartDTO;
import com.foodapp.FoodApp.cart.service.ICartService;
...
public class CartController {
    ...
    @PostMapping("/items")
    public ResponseEntity<Response<?>> addItemCart(@RequestBody CartDTO cartDTO){
