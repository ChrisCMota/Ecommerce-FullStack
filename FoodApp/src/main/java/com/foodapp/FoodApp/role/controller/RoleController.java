package com.foodapp.FoodApp.role.controller;

import com.foodapp.FoodApp.response.Response;
import com.foodapp.FoodApp.role.dtos.RoleDTO;
import com.foodapp.FoodApp.role.service.IRoleService;
...
public class RoleController {
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<Response<?>> deleteRole(@PathVariable @Valid Long id){
